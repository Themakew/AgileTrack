...
<html>
    ...
    <body>
        ...
        <div id="show-features" class="content scaffold-show" role="main">
            ...
            <f:display bean="features" />
            <g:form resource="${this.features}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.features}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
