...
class gsp_AgileTrack_epicindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/epic/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(epicList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(epicCount ?: 0)],-1)
printHtmlPart(13)
})
