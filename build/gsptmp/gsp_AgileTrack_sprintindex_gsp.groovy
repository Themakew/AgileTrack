...
class gsp_AgileTrack_sprintindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/sprint/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(sprintList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(sprintCount ?: 0)],-1)
printHtmlPart(13)
})
