...
class gsp_AgileTrack_taskcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(this.task),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(this.task)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('all','f',30,['bean':("task")],-1)
printHtmlPart(20)
