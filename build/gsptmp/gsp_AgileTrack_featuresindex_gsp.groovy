...
class gsp_AgileTrack_featuresindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/features/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(featuresList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(featuresCount ?: 0)],-1)
printHtmlPart(13)
})
