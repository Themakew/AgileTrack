...
class gsp_AgileTrack_ownerTaskindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/ownerTask/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(ownerTaskList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(ownerTaskCount ?: 0)],-1)
printHtmlPart(13)
})
