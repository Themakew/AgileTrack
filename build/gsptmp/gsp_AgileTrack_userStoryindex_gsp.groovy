...
class gsp_AgileTrack_userStoryindex_gsp extends GroovyPage {
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(userStoryList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(userStoryCount ?: 0)],-1)
printHtmlPart(13)
})
