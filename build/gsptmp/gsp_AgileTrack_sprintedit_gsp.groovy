...
class gsp_AgileTrack_sprintedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/sprint/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'sprint.label', default: 'Sprint'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',26,['bean':(this.sprint),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',28,['bean':(this.sprint)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',30,['name':("version"),'value':(this.sprint?.version)],-1)
printHtmlPart(21)
invokeTag('all','f',32,['bean':("sprint")],-1)
printHtmlPart(22)
expressionOut.print(message(code: 'default.button.update.label', default: 'Update'))
printHtmlPart(23)
})
invokeTag('form','g',37,['resource':(this.sprint),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1459022154000L
