...
class gsp_AgileTrack_investimentThemeshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/investimentTheme/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("investimentTheme")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.investimentTheme)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.investimentTheme),'method':("DELETE")],2)
printHtmlPart(17)
})
