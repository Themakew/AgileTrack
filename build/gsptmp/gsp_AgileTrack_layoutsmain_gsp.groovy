...
class gsp_AgileTrack_layoutsmain_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(5)
invokeTag('image','asset',28,['src':("grails-cupsonly-logo-white.svg")],-1)
printHtmlPart(6)
invokeTag('pageProperty','g',34,['name':("page.nav")],-1)
printHtmlPart(7)
invokeTag('layoutBody','g',40,[:],-1)
printHtmlPart(8)
invokeTag('message','g',45,['code':("spinner.alt"),'default':("Loading&hellip;")],-1)
printHtmlPart(9)
invokeTag('javascript','asset',48,['src':("application.js")],-1)
printHtmlPart(10)
})
...
public static final long LAST_MODIFIED = 1459019547000L
